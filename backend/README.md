...
## Project Structure
    ...
    ├── vitalis_exchange_36323  # Django project configurations
...
1. Clone this repo and `cd vitalis_exchange_36323`
...
2. Clone this repo and `cd vitalis_exchange_36323`
